...
function VitruvianManfacturing(props) {
    return (
        ...
        <h1>add radio button(upload)</h1>
        <h1>add radio button(machining)</h1>
...
function UploadFile(props) {
    return (
        <Page selected={props.selected} id="Upload file ">
            <div>
...
export { VitruvianManfacturing, PartHub, Drivetrain, DrivetrainPhotos, Bumpers, BumperPhotos, Elevator, ElevatorPhotos, Intake, IntakePhotos, AuxiliarySystems, AuxiliarySystemsPhotos, Forebar, ForebarPhotos, ThreeDPrint, ThreeDPrintPhotos, SavePage };